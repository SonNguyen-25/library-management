        ...
        return (
            <>
                ...
                <div className="min-h-screen bg-purple-50 p-6">
                    <div className="text-center py-10 text-purple-700">Loading admin profile...</div>
                </div>
            </>
        );
    }
        ...
        <>
            ...
            <div className="min-h-screen bg-purple-50 p-6">
                <div className="max-w-7xl mx-auto">
                    <h2 className="text-2xl font-semibold text-purple-800 mb-4">Admin Profile</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 bg-white shadow-md rounded-lg p-6">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-lg font-semibold text-purple-800">Profile Information</h3>
                                {!isEditingProfile && (
                            ...
                            {isEditingProfile ? (
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <input type="text" className="w-full border border-gray-300 rounded px-3 py-2 outline-none focus:ring-2 focus:ring-purple-500" value={editedName} onChange={(e) => setEditedName(e.target.value)} />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
                                        <input type="email" className="w-full border border-gray-300 rounded px-3 py-2 outline-none focus:ring-2 focus:ring-purple-500" value={editedEmail} onChange={(e) => setEditedEmail(e.target.value)} />
                                    </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-purple-700">{user.role}</p>
                                    </div>
                                    <div>
                        ...
                        <div className="bg-white shadow-md rounded-lg p-6 h-fit">
                            <h3 className="text-lg font-semibold text-purple-800 mb-4">Change Password</h3>
