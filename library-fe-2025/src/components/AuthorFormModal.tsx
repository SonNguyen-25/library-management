...
export default function AuthorFormModal({ isOpen, onClose, onSubmit, initialData }: Props) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden">
                <div className="p-6 border-b border-gray-100 bg-purple-50 flex justify-between items-center">
                    <h2 className="text-xl font-bold text-purple-800">{initialData ? "Edit Author" : "New Author"}</h2>
